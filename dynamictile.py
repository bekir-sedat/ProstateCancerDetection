...
import os
os.environ['KAGGLE_USERNAME'] = "bsedat" # username from the json file
os.environ['KAGGLE_KEY'] = "ab3df5e338a29fca44f80f5" # key from the json file

!kaggle datasets list -s efficientnet-pytorch

!kaggle datasets download -d hmendonca/efficientnet-pytorch # api copied from kaggle
import zipfile
...
image_idss = [
  ...
  '3385a0f7f4f3e7e7b380325582b115c9', #not includ very smal
  '60502735df319ec33f862579fb6563d5', #not includ very smal
  '41a2f4193aa1effcd56bac44e7affb03',  #not includ very smal
  'eb88414bf869f5f93e3990b0d08c3bf3', #not includ very sma
  '040b2c98538ec7ead1cbd6daacdb3f64', #- 1088 weird color
  '3790f55cad63053e956fb73027179707', #total empty
...
def getEliminationIds(images):
    ...
    if (N>0):
      ...
      c = images[0].shape[2]
      t = h*w*c
      #print('TOTAL PIXEL ',h*w)
    #print("total N ",N )
      
      #_, ax = plt.subplots(1,N, figsize = (50,50))
      for i in range(N):
        ...
        #print('image ', i)
          ...
          for hh in range(h):
              for ww in range(w):
                  ...
                  #if(img[hh,ww,0]<220 and img[hh,ww,2]<220 and img[hh,ww,2]<220):
...
import os
#new_Folder = 'model'
new_Folder = '/content/gdrive/My Drive/Panda/Dynamic_256__target_768_b0_day4444444'
...
for epoch in range(start_epoch, n_epochs+start_epoch):
    ...
    scheduler.step(val_loss) #####Added later
